...
LOCK = HOME + '/lock/downloader_JMAWIS_txt_surface.lock'

URL = 'http://www.wis-jma.go.jp/data/syn?ContentType=Text&Category=Surface&Type=Alphanumeric&Access=Open&Subcategory=BUOY&Subcategory=SHIP&Subcategory=SYNOP&Subcategory=SYNOP%20MOBIL'
