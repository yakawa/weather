...
LOCK = HOME + '/lock/downloader_JMAWIS_txt_forecast.lock'

URL = 'http://www.wis-jma.go.jp/data/syn?ContentType=Text&Category=Forecast&Type=Alphanumeric&Access=Open&Subcategory=Tropical%20cyclone%20advisories&Subcategory=Volcanic%20ash%20advisories'
