...
LOCK = HOME + '/lock/downloader_JMAWIS_txt_upper.lock'

URL = 'http://www.wis-jma.go.jp/data/syn?ContentType=Text&Category=Upper%20air&Type=Alphanumeric&Access=Open&Subcategory=AIREP&Subcategory=AMDAR&Subcategory=PILOT&Subcategory=PIREP&Subcategory=TEMP&Subcategory=TEMP%20and%20PILOT&Subcategory=TEMP%20DROP&Subcategory=TEMP%20MOBIL&Subcategory=TEMP%20SHIP"'
