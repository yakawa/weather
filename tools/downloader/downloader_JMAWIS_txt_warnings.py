...
LOCK = HOME + '/lock/downloader_JMAWIS_txt_warnings.lock'

URL = 'http://www.wis-jma.go.jp/data/syn?ContentType=Text&Category=Warning&Type=Alphanumeric&Access=Open&Subcategory=Tropical%20cyclone&Subcategory=Tsunami&Subcategory=Warnings%20and%20weather%20summary'
